...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        private int afstand, tijd, vermogen, rpm, uur, min, bpm;
        ...
        public void DataReceivedHandler(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            if (indata.Contains("PW"))
            {
                ...
                port.WriteLine($"{bpm} {rpm} {(snelheid * 3.6):00.0} {afstand} {vermogen} {(int)kJ} {uur}:{min} 0 ");
            }
            ...
            if (indata.Contains("PE"))
            {
                ...
                filter = filter.Replace("\n", "");
                ResetData();
                kJ = int.Parse(filter.Replace("PE ", "").Trim());
